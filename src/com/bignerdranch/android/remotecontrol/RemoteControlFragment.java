...
public class RemoteControlFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
		...
		// Handles the last row of three buttons separately
		TableRow bottomRow = (TableRow) tableLayout.getChildAt(tableLayout.getChildCount()-1);
		
		Button deleteButton = (Button) bottomRow.getChildAt(0);			//Delete button
		...
		Button zeroButton = (Button) bottomRow.getChildAt(1);			//Zero button
		zeroButton.setText("0");
		zeroButton.setOnClickListener(numberButtonListener);
		
		Button enterButton = (Button) bottomRow.getChildAt(2);			//Enter button
